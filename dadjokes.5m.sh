...
# <xbar.image>https://raw.githubusercontent.com/simonpeier/xbar-dadjokes-plugin/master/screenshot.png</xbar.image>
# <xbar.dependencies>bash</xbar.dependencies>
# <xbar.abouturl>https://simonpeier.github.io/xbar-dadjokes-plugin/</xbar.abouturl>
